...
if(page<1){page=1}
let qs_param=sprintf("/dashboard/subtitle/{imdb}/?movie={movie}&season={season}&page={page}",{"movie":encodeURIComponent($("#id_movie").val()),"imdb":$("#id_imdb").val(),"season":$("#id_season").val(),"page":page,})
