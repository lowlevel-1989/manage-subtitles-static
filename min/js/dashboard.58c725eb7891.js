...
template_content.append(sprintf(template_html,{user:parent.data("metadataUser"),consumers:parent.data("metadataConsumers"),imdb:parent.data("metadataImdb"),lang:parent.data("metadataLang"),hash:parent.data("metadataHash"),name:parent.data("metadataFilename")}))
